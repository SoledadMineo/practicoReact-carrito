...
app.post("/api/instrumentos", async (req, res) => {
  ...
  try {
    for (const instrumento of instrumentos) {
      await pool.query(
        `
        INSERT INTO instrumento (id, instrumento, marca, modelo, imagen, precio, costoEnvio, cantidadVendida, descripcion)
        VALUES ( [{
			"id":"1",
      ...
      `,
        [
          parseInt(instrumento.id),
          instrumento.instrumento,
          instrumento.marca,
          instrumento.modelo,
          instrumento.imagen,
          parseFloat(instrumento.precio),
          instrumento.costoEnvio,
          parseInt(instrumento.cantidadVendida),
